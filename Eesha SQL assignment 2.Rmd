...
#We can see from this plot that the avg tip amount seems to consistently vary with avg total amount of fare, but also that is similar for three types of payments(cash, disputed fare, no charge), but disputed has the largest relative avg tip amounts
